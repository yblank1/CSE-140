...
/* Generation options: */
#ifndef __model_mkTbBCM_h__
#define __model_mkTbBCM_h__
...
/* Class declaration for a model of mkTbBCM */
class MODEL_mkTbBCM : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTbBCM *mkTbBCM_instance;
...
#endif /* ifndef __model_mkTbBCM_h__ */
